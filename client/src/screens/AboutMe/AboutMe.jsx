...
export default function AboutMe() {
  return (
    <div>
      <h3 className="about-me" id="about-me">ABOUT ME</h3>
      <div className="container">

        <div className="about-me-container">

          <p>I am a Software Engineer who strives to use my passion for technology and my skills in web development to make meaningful contributions to the world. I have experience building full-stack applications with JavaScript, Ruby on Rails, MongoDB, HTML5, and CSS3 with technologies including PostgreSQL, and React. In the future, I look forward to also learning new skills that will help me stay on the cusp of where technology meets humanity.
<br></br>
            <br></br>
