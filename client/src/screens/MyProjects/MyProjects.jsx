        ...
        <div className="project-container">
          ...
          <div className="each-project-info">
            ...
            <div className="project-buttons">
              ...
              <a
                target="_blank"
                href="https://github.com/thethomasmiller/SubBusters"
                style={{ textDecoration: 'none' }}>
        ...
        <div className="project-image">
          ...
          <div className="each-project-info">
            ...
            <div className="project-buttons">
              ...
              <a
                target="_blank"
                href="https://github.com/KellyAppiah/SerenitySkins"
                style={{ textDecoration: 'none' }}>    <Button variant="outline-light" block>REPO</Button>
              </a>
            </div>
          </div>
