      ...
      <div className="all-projects">
        <div className="project-container">
          ...
          <div className="all-projects-info">
            ...
            <p>Serenity Skin Spa is an alrady existing local business, whos mission is to enhance beauty and confidence in their clients by using innovating pratices. The website allows users to login and book appointments. Clients will be able to view treatements provided once they log in. They will also be able to view description, duration and price of the treatement selcted. This interactive site was made using React, CSS3, Ruby on Rails framework for Data Management and PostgreSQL for the database. </p>
            <div className="project-buttons">
